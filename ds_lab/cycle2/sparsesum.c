...
int main(){
    ...
    struct sparsematrix fsparse[100],ssparse[100],sumsparse[100];
    ...
    for(int i=0;i<ssparse[0].row;i++){
        for(int j=0;j<ssparse[0].col;j++){
            if(fsparse[a].row==i && fsparse[a].col==j && ssparse[b].row==i && ssparse[b].col==j){
                sumsparse[c].row=i;
                sumsparse[c].col=j;
                ...
                sumsparse[c].row=i;
                sumsparse[c].col=j;
                sumsparse[c].value=fsparse[a].value;
                a++;
                c++;
            }
